...
BOARD_SYSTEM_DLKMIMAGE_EROFS_COMPRESS_HINTS := $(DEVICE_PATH)/configs/erofs_compress_hints.txt
...
BOARD_VENDOR_DLKMIMAGE_EROFS_COMPRESS_HINTS := $(DEVICE_PATH)/configs/erofs_compress_hints.txt
...
include device/xperience/sepolicy/libion/sepolicy.mk
include device/xperience/sepolicy/libperfmgr/sepolicy.mk
